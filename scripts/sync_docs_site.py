...
ROUTE_MAP = [
    ...
    ("internal/diagnostic-codes", "DIAGNOSTIC_CODES_REFERENCE.md"),
    ("internal/token-construct-coverage", "TOKEN_CONSTRUCT_COVERAGE_MATRIX.md"),
    ("internal/scope-visibility", "SCOPE_VISIBILITY_V1_1.md"),
    ("internal/implementation-plan", "docs/SKADI_IMPLEMENTATION_PLAN_RU.md"),
    ("internal/v1-1-plan", "SKADI_V1_1_PLAN_RU.md"),
    ("internal/v1-1-roadmap", "V1_1_ROADMAP.md"),
    ...
    ("internal/edit-borrow-resource-contract", "SKADI_EDIT_BORROW_RESOURCE_CONTRACT_RU.md"),
