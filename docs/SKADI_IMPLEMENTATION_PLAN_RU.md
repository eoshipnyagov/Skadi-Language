...
## Этап 1 — Стабилизация ядра parser
...
## Этап 2 — Движок выражений (Pratt parser)
...
## Этап 5 — Расширение языковых фич
...
## Этап 6 — Ближайший review дизайна языка
...
## Этап 7 — Реализация List/Text v1
...
## Этап 8 — Планирование и переход к `v1.1`
