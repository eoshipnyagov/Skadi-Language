...
Date: 2026-07-19
Status: historical close-out; the active development line is `v1.2`
...
1. Scope/Visibility contract implementation ([contract](scope-visibility.md))
- shadowing forbidden,
...
The release-blocking scope/visibility, diagnostic, struct-lowering, CLI, math, and documentation work is implemented. Module-name imports and aliases remain explicitly deferred; the current stable module surface is relative path imports plus `module.symbol` qualification.

Further runtime work is tracked in the [v1.2 plan](v1-2-plan.md).
