...
- Что уже закрыто:
  ...
  - добавлены детерминированные import-диагностики:
    - `[SC-MOD-002]` для коллизий публичных символов,
    - `[SC-MOD-003]` для direct-import-only нарушений (transitive access из entry),
  ...
  - reference-файл с ownership и кодами: `docs/internal/DIAGNOSTIC_CODES_REFERENCE.md`,
